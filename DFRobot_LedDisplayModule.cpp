...
void DFRobot_LedDisplayModule::print4(double sensorData)
{
    ...
    if (temp < 10)
    {
        ...
        {
        case 1:
            sensorGetDisplayAddress4();
            i2cWriteData4(a1, TAB_Point2[cacheData1 - 48]);
        ...
        case 2:
            sensorGetDisplayAddress4();
            i2cWriteData4(a1, TAB_Point2[cacheData1 - 48]);
            i2cWriteData4(a2, TAB2[cacheData3 - 48]);
            i2cWriteData4(d1, 0x00);
            i2cWriteData4(d2, 0x00);
            break;
        case 3:
            ...
            i2cWriteData4(a1, TAB_Point2[cacheData1 - 48]);
            i2cWriteData4(a2, TAB2[cacheData3 - 48]);
            i2cWriteData4(a3, TAB2[cacheData4 - 48]);
            i2cWriteData4(d1, 0x00);
            break;
        case 4:
            i2cWriteData4(0, TAB_Point2[cacheData1 - 48]);
            i2cWriteData4(1, TAB2[cacheData3 - 48]);
            i2cWriteData4(2, TAB2[cacheData4 - 48]);
            i2cWriteData4(3, TAB2[cacheData5 - 48]);
            break;
        }
    }
    else if (temp >= 10 && temp < 100)
    {
        ...
        case 1:
            sensorGetDisplayAddress4();
            i2cWriteData4(a1, TAB2[cacheData1 - 48]);
            i2cWriteData4(d1, 0x00);
            i2cWriteData4(d2, 0x00);
            i2cWriteData4(d3, 0x00);
            break;
        case 2:
            sensorGetDisplayAddress4();
            i2cWriteData4(a1, TAB2[cacheData1 - 48]);
            i2cWriteData4(a2, TAB_Point2[cacheData2 - 48]);
            i2cWriteData4(d1, 0x00);
            i2cWriteData4(d2, 0x00);
            break;
        case 3:
            ...
            break;
        case 4:
            i2cWriteData4(0, TAB2[cacheData1 - 48]);
            i2cWriteData4(1, TAB_Point2[cacheData2 - 48]);
            i2cWriteData4(2, TAB2[cacheData4 - 48]);
            i2cWriteData4(3, TAB2[cacheData5 - 48]);
            break;
        }
    ...
    else if (temp >= 100 && temp < 1000)
    {
        ...
        case 2:
            sensorGetDisplayAddress4();
            i2cWriteData4(a1, TAB2[cacheData1 - 48]);
            i2cWriteData4(a2, TAB2[cacheData2 - 48]);
            i2cWriteData4(d1, 0x00);
            i2cWriteData4(d2, 0x00);
            break;
        case 3:
            ...
            i2cWriteData4(a1, TAB2[cacheData1 - 48]);
            i2cWriteData4(a2, TAB2[cacheData2 - 48]);
            i2cWriteData4(a3, TAB_Point2[cacheData3 - 48]);
            i2cWriteData4(d1, 0x00);
            break;
        case 4:
            i2cWriteData4(0, TAB2[cacheData1 - 48]);
            i2cWriteData4(1, TAB2[cacheData2 - 48]);
            i2cWriteData4(2, TAB_Point2[cacheData3 - 48]);
            i2cWriteData4(3, TAB2[cacheData5 - 48]);
            break;
        }
    }
    else if (temp >= 1000)
    {
        ...
        case 3:
            ...
            i2cWriteData4(a1, TAB2[cacheData1 - 48]);
            i2cWriteData4(a2, TAB2[cacheData2 - 48]);
            i2cWriteData4(a3, TAB2[cacheData3 - 48]);
            i2cWriteData4(d1, 0x00);
            break;
        case 4:
            i2cWriteData4(0, TAB2[cacheData1 - 48]);
            i2cWriteData4(1, TAB2[cacheData2 - 48]);
            i2cWriteData4(2, TAB2[cacheData3 - 48]);
            i2cWriteData4(3, TAB2[cacheData4 - 48]);
            break;
        }
    }
}
...
void DFRobot_LedDisplayModule::print4(const char buf1[], const char buf2[], const char buf3[], const char buf4[])
{
    ...
    case 3:
        ...
        i2cWriteData4(a1, data1);
        i2cWriteData4(a2, data2);
        i2cWriteData4(a3, data3);
        i2cWriteData4(d1, 0x00);
        break;
    case 4:
        i2cWriteData4(d41 - 1, data1);
        i2cWriteData4(d42 - 1, data2);
        i2cWriteData4(d43 - 1, data3);
        i2cWriteData4(d44 - 1, data4);
        break;
    }
    printCacheReset();
}
...
void DFRobot_LedDisplayModule::print8(double sensorData)
{
    ...
    if (temp < 10)
    {
        ...
        {
        case 1:
            sensorGetDisplayAddress8();
            i2cWriteData(a1, TAB_Point2[cacheData1 - 48]);
        ...
        case 2:
            sensorGetDisplayAddress8();
            i2cWriteData(a1, TAB_Point2[cacheData1 - 48]);
            i2cWriteData(a2, TAB2[cacheData3 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 3:
            ...
            i2cWriteData(a1, TAB_Point2[cacheData1 - 48]);
            i2cWriteData(a2, TAB2[cacheData3 - 48]);
            i2cWriteData(a3, TAB2[cacheData4 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 4:
            ...
            i2cWriteData(a2, TAB2[cacheData3 - 48]);
            i2cWriteData(a3, TAB2[cacheData4 - 48]);
            i2cWriteData(a4, TAB2[cacheData5 - 48]);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
            i2cWriteData(d1, 0x00);
        ...
        case 5:
            ...
            i2cWriteData(a3, TAB2[cacheData4 - 48]);
            i2cWriteData(a4, TAB2[cacheData5 - 48]);
            i2cWriteData(a5, TAB2[cacheData6 - 48]);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d1, 0x00);
            break;
        case 6:
            ...
            i2cWriteData(a4, TAB2[cacheData5 - 48]);
            i2cWriteData(a5, TAB2[cacheData6 - 48]);
            i2cWriteData(a6, TAB2[cacheData7 - 48]);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d1, 0x00);
            break;
        case 7:
            ...
            i2cWriteData(a5, TAB2[cacheData6 - 48]);
            i2cWriteData(a6, TAB2[cacheData7 - 48]);
            i2cWriteData(a7, TAB2[cacheData8 - 48]);
            i2cWriteData(d1, 0x00);
            break;
        case 8:
            i2cWriteData(0, TAB_Point2[cacheData1 - 48]);
            i2cWriteData(1, TAB2[cacheData3 - 48]);
            i2cWriteData(2, TAB2[cacheData4 - 48]);
            i2cWriteData(3, TAB2[cacheData5 - 48]);
            i2cWriteData(4, TAB2[cacheData6 - 48]);
            i2cWriteData(5, TAB2[cacheData7 - 48]);
            i2cWriteData(6, TAB2[cacheData8 - 48]);
            i2cWriteData(7, TAB2[cacheData9 - 48]);
            break;
        }
    }
    else if (temp >= 10 && temp < 100)
    {
        ...
        case 1:
            sensorGetDisplayAddress8();
            i2cWriteData(a1, TAB2[cacheData1 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 2:
            sensorGetDisplayAddress8();
            i2cWriteData(a1, TAB2[cacheData1 - 48]);
            i2cWriteData(a2, TAB_Point2[cacheData2 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 7:
            ...
            break;
        case 8:
            i2cWriteData(0, TAB2[cacheData1 - 48]);
            i2cWriteData(1, TAB_Point2[cacheData2 - 48]);
            i2cWriteData(2, TAB2[cacheData4 - 48]);
            i2cWriteData(3, TAB2[cacheData5 - 48]);
            i2cWriteData(4, TAB2[cacheData6 - 48]);
            i2cWriteData(5, TAB2[cacheData7 - 48]);
    ...
    else if (temp >= 100 && temp < 1000)
    {
        ...
        case 2:
            sensorGetDisplayAddress8();
            i2cWriteData(a1, TAB2[cacheData1 - 48]);
            i2cWriteData(a2, TAB2[cacheData2 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 3:
            ...
            i2cWriteData(a1, TAB2[cacheData1 - 48]);
            i2cWriteData(a2, TAB2[cacheData2 - 48]);
            i2cWriteData(a3, TAB_Point2[cacheData3 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 8:
            i2cWriteData(0, TAB2[cacheData1 - 48]);
            i2cWriteData(1, TAB2[cacheData2 - 48]);
            i2cWriteData(2, TAB_Point2[cacheData3 - 48]);
            i2cWriteData(3, TAB2[cacheData5 - 48]);
            i2cWriteData(4, TAB2[cacheData6 - 48]);
            i2cWriteData(5, TAB2[cacheData7 - 48]);
            i2cWriteData(6, TAB2[cacheData8 - 48]);
    ...
    else if (temp >= 1000 && temp < 10000)
    {
        ...
        case 3:
            ...
            i2cWriteData(a1, TAB2[cacheData1 - 48]);
            i2cWriteData(a2, TAB2[cacheData2 - 48]);
            i2cWriteData(a3, TAB2[cacheData3 - 48]);
            i2cWriteData(d1, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
        ...
        case 4:
            ...
            i2cWriteData(a2, TAB2[cacheData2 - 48]);
            i2cWriteData(a3, TAB2[cacheData3 - 48]);
            i2cWriteData(a4, TAB_Point2[cacheData4 - 48]);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
            i2cWriteData(d1, 0x00);
        ...
        case 8:
            i2cWriteData(0, TAB2[cacheData1 - 48]);
            i2cWriteData(1, TAB2[cacheData2 - 48]);
            i2cWriteData(2, TAB2[cacheData3 - 48]);
            i2cWriteData(3, TAB_Point2[cacheData4 - 48]);
            i2cWriteData(4, TAB2[cacheData6 - 48]);
            i2cWriteData(5, TAB2[cacheData7 - 48]);
            i2cWriteData(6, TAB2[cacheData8 - 48]);
            i2cWriteData(7, TAB2[cacheData9 - 48]);
    ...
    else if (temp >= 10000 && temp < 100000)
    {
        ...
        case 4:
            ...
            i2cWriteData(a2, TAB2[cacheData2 - 48]);
            i2cWriteData(a3, TAB2[cacheData3 - 48]);
            i2cWriteData(a4, TAB2[cacheData4 - 48]);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d4, 0x00);
            i2cWriteData(d1, 0x00);
        ...
        case 5:
            ...
            i2cWriteData(a3, TAB2[cacheData3 - 48]);
            i2cWriteData(a4, TAB2[cacheData4 - 48]);
            i2cWriteData(a5, TAB_Point2[cacheData5 - 48]);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d1, 0x00);
            break;
        ...
        case 8:
            ...
            i2cWriteData(1, TAB2[cacheData2 - 48]);
            i2cWriteData(2, TAB2[cacheData3 - 48]);
            i2cWriteData(3, TAB2[cacheData4 - 48]);
            i2cWriteData(4, TAB_Point2[cacheData5 - 48]);
            i2cWriteData(5, TAB2[cacheData7 - 48]);
            i2cWriteData(6, TAB2[cacheData8 - 48]);
            i2cWriteData(7, TAB2[cacheData9 - 48]);
            break;
    ...
    else if (temp >= 100000 && temp < 1000000)
    {
        ...
        case 5:
            ...
            i2cWriteData(a3, TAB2[cacheData3 - 48]);
            i2cWriteData(a4, TAB2[cacheData4 - 48]);
            i2cWriteData(a5, TAB2[cacheData5 - 48]);
            i2cWriteData(d3, 0x00);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d1, 0x00);
            break;
        case 6:
            ...
            i2cWriteData(a4, TAB2[cacheData4 - 48]);
            i2cWriteData(a5, TAB2[cacheData5 - 48]);
            i2cWriteData(a6, TAB_Point2[cacheData6 - 48]);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d1, 0x00);
            break;
        case 7:
        ...
        case 8:
            ...
            i2cWriteData(2, TAB2[cacheData3 - 48]);
            i2cWriteData(3, TAB2[cacheData4 - 48]);
            i2cWriteData(4, TAB2[cacheData5 - 48]);
            i2cWriteData(5, TAB_Point2[cacheData6 - 48]);
            i2cWriteData(6, TAB2[cacheData8 - 48]);
            i2cWriteData(7, TAB2[cacheData9 - 48]);
            break;
        }
    ...
    else if (temp >= 1000000 && temp < 10000000)
    {
        ...
        case 6:
            ...
            i2cWriteData(a4, TAB2[cacheData4 - 48]);
            i2cWriteData(a5, TAB2[cacheData5 - 48]);
            i2cWriteData(a6, TAB2[cacheData6 - 48]);
            i2cWriteData(d2, 0x00);
            i2cWriteData(d1, 0x00);
            break;
        case 7:
            ...
            i2cWriteData(a5, TAB2[cacheData5 - 48]);
            i2cWriteData(a6, TAB2[cacheData6 - 48]);
            i2cWriteData(a7, TAB_Point2[cacheData7 - 48]);
            i2cWriteData(d1, 0x00);
            break;
        case 8:
            i2cWriteData(0, TAB2[cacheData1 - 48]);
            ...
            i2cWriteData(3, TAB2[cacheData4 - 48]);
            i2cWriteData(4, TAB2[cacheData5 - 48]);
            i2cWriteData(5, TAB2[cacheData6 - 48]);
            i2cWriteData(6, TAB_Point2[cacheData7 - 48]);
            i2cWriteData(7, TAB2[cacheData9 - 48]);
            break;
        }
    }
    else if (temp >= 10000000)
    {
        ...
        case 7:
            ...
            i2cWriteData(a5, TAB2[cacheData5 - 48]);
            i2cWriteData(a6, TAB2[cacheData6 - 48]);
            i2cWriteData(a7, TAB2[cacheData7 - 48]);
            i2cWriteData(d1, 0x00);
            break;
        case 8:
            i2cWriteData(0, TAB2[cacheData1 - 48]);
            ...
            i2cWriteData(4, TAB2[cacheData5 - 48]);
            i2cWriteData(5, TAB2[cacheData6 - 48]);
            i2cWriteData(6, TAB2[cacheData7 - 48]);
            i2cWriteData(7, TAB2[cacheData8 - 48]);
            break;
        }
    }
}
...
void DFRobot_LedDisplayModule::print8(const char buf1[], const char buf2[], const char buf3[], const char buf4[], const char buf5[], const char buf6[], const char buf7[], const char buf8[])
{
    ...
    case 7:
        ...
        i2cWriteData(a5, data5);
        i2cWriteData(a6, data6);
        i2cWriteData(a7, data7);
        i2cWriteData(d1, 0x00);
        break;
    case 8:
        i2cWriteData(d81 - 1, data1);
        i2cWriteData(d82 - 1, data2);
        i2cWriteData(d83 - 1, data3);
        i2cWriteData(d84 - 1, data4);
        i2cWriteData(d85 - 1, data5);
        i2cWriteData(d86 - 1, data6);
        i2cWriteData(d87 - 1, data7);
        i2cWriteData(d88 - 1, data8);
        break;
    }
    printCacheReset();
}
